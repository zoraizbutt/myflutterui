...
class orginizerlist extends StatefulWidget {
  @override
  _State createState() => _State();
}

class _State extends State<orginizerlist> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            title:Row(
                children:[
                  Text("Orginizer List",style:TextStyle(fontSize: 22,fontWeight: FontWeight.bold,color: Colors.black)
                  )
