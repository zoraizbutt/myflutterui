  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title:Row(
            children:[
              Text("Users List",style:TextStyle(fontSize: 22,fontWeight: FontWeight.bold,color: Colors.black)
              )
                          ...
                          children: <Widget>[
                            Padding(padding:EdgeInsets.fromLTRB(10, 10,0 , 0),
                              ...
                              decoration: BoxDecoration(
                                ...
                                child:Text("Band",style:TextStyle(color:Colors.white))
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Row(children: [
                          ...
                          Padding(padding:EdgeInsets.fromLTRB(120, 1,0 , 0),
                            child:Container( height: 30.0,
                              width: 30.0,
                              decoration: BoxDecoration(
                                //borderRadius: BorderRadius.circular(10.0),
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Padding(padding:EdgeInsets.fromLTRB(80, 10,0 , 0),
                              child:SmoothStarRating(
                                  allowHalfRating: false,
                                  onRated: (v) {
                                  },
