...
import 'package:flutter_appasg/supplierlist.dart';
...
class _starsState extends State<suppliers> {
  @override
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            title:Row(children:<Widget>[
              ...
              Container(
                child:Text("Suppliers",style:TextStyle(fontWeight: FontWeight.bold,fontSize: 25,color: Colors.black)
