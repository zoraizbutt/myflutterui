...
import 'eventorginizerlist.dart';



class eventorginizer extends StatefulWidget {
  @override
  _starsState createState() => _starsState();
}

class _starsState extends State<eventorginizer> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            title:Row(children:<Widget>[
              ...
              Container(
                child:Text("Event Orginizer",style:TextStyle(fontWeight: FontWeight.bold,fontSize: 25,color: Colors.black)
    ...
    context,
    MaterialPageRoute(builder: (context) => orginizerlist()),
    );
    },
